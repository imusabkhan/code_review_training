...
"[project]/.next-internal/server/app/api/challenge-locks/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/api/challenge-locks/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        // Return as { [id]: locked }
        const lockMap = Object.fromEntries(locks.map((l)=>[
                l.id,
                l.locked
            ]));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(lockMap);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6299dbfa._.js.map